...
namespace CrmEarlyBound
{
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/oas/")]
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("oas_GetReferenceByName")]
	public partial class oas_GetReferenceByNameRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		...
		public string ReturnParameterName
		{
			get
			{
				if (this.Parameters.Contains("ReturnParameterName"))
				{
					return ((string)(this.Parameters["ReturnParameterName"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["ReturnParameterName"] = value;
			}
		}
		
		public oas_GetReferenceByNameRequest()
		{
			this.RequestName = "oas_GetReferenceByName";
			this.EntityType = default(string);
			this.EntityName = default(string);
			this.ReturnParameterName = default(string);
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/oas/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("oas_GetReferenceByName")]
	public partial class oas_GetReferenceByNameResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public oas_GetReferenceByNameResponse()
		{
		}
